...
(function bootstrapI18n() {
    ...
    const translations = {
        en: {
            ...
            'resume.overlayAria': 'Resume previous game',
            'resume.title': 'Continue your saved tournament?',
            'resume.description': 'A previous run was interrupted. Continue where you left off or restart.',
            'resume.continue': 'Continue',
            'resume.continueAria': 'Continue saved tournament',
            'resume.restart': 'Restart',
            'resume.restartAria': 'Restart tournament from round one',
            ...
            'word.secondChanceWrongLettersDesc': 'Wrong. Wrong letters: {letters}. Try again.',
            'word.secondChanceWrongLettersUnknown': 'none',
        ...
        de: {
            ...
            'resume.overlayAria': 'Vorheriges Spiel fortsetzen',
            'resume.title': 'Gespeichertes Turnier fortsetzen?',
            'resume.description': 'Ein vorheriger Lauf wurde unterbrochen. Möchtest du weiterspielen oder neu starten?',
            'resume.continue': 'Fortsetzen',
            'resume.continueAria': 'Gespeichertes Turnier fortsetzen',
            'resume.restart': 'Neu starten',
            'resume.restartAria': 'Turnier ab Runde eins neu starten',
            ...
            'word.secondChanceWrongLettersDesc': 'Falsch. Falsche Buchstaben: {letters}. Versuche es noch einmal.',
            'word.secondChanceWrongLettersUnknown': 'keine',
    ...
    const heTranslations = {
        ...
        'resume.overlayAria': 'המשך משחק קודם',
        'resume.title': 'להמשיך טורניר שמור?',
        'resume.description': 'המשחק הקודם הופסק. אפשר להמשיך מאותה נקודה או להתחיל מחדש.',
        'resume.continue': 'המשך',
        'resume.continueAria': 'המשך הטורניר השמור',
        'resume.restart': 'התחל מחדש',
        'resume.restartAria': 'התחל טורניר מחדש מסיבוב ראשון',
        ...
        'word.secondChanceWrongLettersDesc': 'לא נכון. האותיות השגויות: {letters}. נסה שוב.',
        'word.secondChanceWrongLettersUnknown': 'אין',
